...
const programData = {
  ...
  dy_sobang: {
    icon: '📸', name: '대영소방 현장기록 (DY-Sobang FieldLog)', tag: '🚧 베타 · 현장기록',
    desc: '소방 점검 현장에서 사진 + 음성 메모를 즉시 기록하는 안드로이드 앱. GPS·주소·시각·메모·사업장이 사진에 워터마크로 자동 합성되어, 사진 한 장이 그 자체로 점검 보고서 역할을 합니다. 한국어 음성인식(STT)으로 받아쓰기 후 카톡·드라이브·메일로 즉시 공유. 현재 베타 테스트 중 — 정식 출시 시 [AI 프로그램] 탭으로 이동됩니다. (베타 다운로드 URL: hankal0501-ux.github.io/firesugi-blog/dy-sobang/)',
    features: [
    ...
    howto: [
      '1. 베타 테스터: 카톡으로 받은 APK 또는 다운로드 페이지에서 APK 설치 → 권한 3개 허용 (카메라·마이크·위치).',
    ...
    link: null,
    version: 'v1.0.0 베타',
    platform: 'Android (APK 직접 설치 · 5명 이상 베타 테스터)',
