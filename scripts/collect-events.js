...
const FIRELAW_NOISE_RE = /순직|숨진|사망|부상|참사|검거|구속|기소|성추행|폭행|음주|비리|횡령|선정|위촉|임명|간담회|워크숍|캠페인|봉사|기부|성금|채용/;
...
const FIRELAW_ACTIONS = [
  ['입법예고', /입법예고/], ['행정예고', /행정예고/], ['고시', /고시|발령|공포/],
  ['제정', /제정/], ['개정', /개정|일부개정|전부개정/], ['시행', /시행/]
];
